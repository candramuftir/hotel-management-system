...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="active" href="<?php echo base_url().'admin/events'?>"><i class="si si-calendar"></i><span class="sidebar-mini-hide">Events</span></a>
                                </li>
                                <li>
                                    ...
                                    <table id="mytable" class="table table-striped">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row->event_jadwal;?></td>
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/events/simpan_events'?>" method="post">
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            ...
                            <div class="form-group">
                                <input type="text" name="xjadwal" class="form-control" placeholder="Jadwal Event" required>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/events/update_events'?>" method="post">
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/events/hapus_events'?>" method="post">
