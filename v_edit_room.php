    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="active" href="<?php echo base_url().'admin/room'?>"><i class="si si-star"></i><span class="sidebar-mini-hide">Room & Suite</span></a>
                                </li>
                                <li>
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                <form action="<?php echo base_url().'admin/room/update_room'?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="block">
                                ...
                                <div class="block-content">
                                    ...
                                    <div class="form-group">
                                        <input type="file" name="userfile" class="dropify" data-height="290" data-default-file="<?php echo base_url().'assets/images/'.$b['gambar_large'];?>">
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <div class="form-group">
                                        <input type="file" name="userfile2" class="dropify2" data-height="350" data-default-file="<?php echo base_url().'assets/images/'.$b['gambar_kotak'];?>">
                                    </div>
                                    <div class="form-group">
                                            <select name="xtype" class="form-control" required>
                                                ...
                                                ?>
                                                <?php if($b['type']==$row->type_nama):?>
                                                    <option value="<?php echo $row->type_nama;?>" selected><?php echo $row->type_nama;?></option>
                                                <?php else:?>
                                    ...
                                    <div class="form-group">
                                            <input type="number" name="xrate" value="<?php echo $b['rate'];?>" class="form-control" placeholder="Publish Rate" required>
                                    </div>
                                </div>
                                <div class="block-content block-content-full block-content-md bg-body-light">
                                    <input type="hidden" name="xkode" value="<?php echo $b['kd_compare']?>" required>
                                    <input type="hidden" name="ximg_large" value="<?php echo $b['gambar_large']?>">
                                    <input type="hidden" name="ximg_thumb" value="<?php echo $b['gambar_kotak']?>">
