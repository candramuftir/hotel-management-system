                            ...
                            <ul class="nav-main">
                                ...
                                <li class="open">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a class="active" href="<?php echo base_url().'admin/kategori'?>">Categories</a>
                                        </li>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    ...
                    <div class="float-left">
                        <a class="font-w600" href="https://candramf.com" target="_blank">Candra Mufti Ramadhan</a> &copy; <span class="js-year-copy">2020</span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
