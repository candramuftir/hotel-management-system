...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll main-content-boxed side-trans-enabled page-header-fixed">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="active" href="<?php echo base_url().'admin/fasilitas'?>"><i class="si si-badge"></i><span class="sidebar-mini-hide">Fasilities</span></a>
                                </li>
                                <li>
            ...
            <!-- END Header -->
            <?php 
                $b=$fasilitas->row_array();
            ?>
            <!-- Main Container -->
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                <form action="<?php echo base_url().'admin/fasilitas/update_fasilitas'?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Edit Fasilitas & Services</h3>
                                </div>
                                <div class="block-content">
                                    
                                    <div class="form-group">
                                            <input type="text" name="xnama" value="<?php echo $b['nama'];?>" class="form-control" placeholder="Nama Fasilitas & Services" required>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <div class="form-group">
                                        <input type="file" name="filefoto" class="dropify2" data-height="230" data-default-file="<?php echo base_url().'assets/images/'.$b['gambar'];?>">
                                    </div>
                                    
                                    
                                </div>
                                <div class="block-content block-content-full block-content-md bg-body-light">
                                    <input type="hidden" name="kode" value="<?php echo $b['kd_fasilitas'];?>" required>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $('.dropify2').dropify({
                    messages: {
                        default: 'Image 770 X 420 Pixels',
                        replace: 'Ganti',
                        remove:  'Hapus',
                        error:   'error'
                    }
