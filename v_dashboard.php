                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="<?php echo base_url().'admin/dashboard'?>">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">ATRIA </span><span class="font-size-xl text-success"><strong>Hotels</strong></span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    <div class="float-right">
                        Crafted with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="http://candramf.com" target="_blank">Candra Mufti Ramadhan</a>
                    </div>
